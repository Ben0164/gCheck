...
public class ExpenseFormActivity extends AppCompatActivity {
    ...
    private final String[] PHASES = {"Land Preparation", "Crop Establishment", "Crop Management", "Reproductive/Ripening Monitoring", "Harvesting", "Post-Harvest"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupAdapters();
        setupListeners();
        String preSelectedPhase = getIntent().getStringExtra(EXTRA_PHASE);
        ...
        if (expenseId != -1) loadExistingExpense(expenseId);
    }
    ...
    private void setupListeners() {
        spCategory.setOnItemClickListener((parent, view, position, id) -> updateProductAdapter((String) parent.getItemAtPosition(position)));
    ...
    private void calculateTotal() {
        try {
            ...
            } else tvTotalCost.setText("₱0.00");
        } catch (Exception e) { tvTotalCost.setText("₱0.00"); }
    }
