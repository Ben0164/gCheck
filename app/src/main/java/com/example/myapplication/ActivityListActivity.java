...
public class ActivityListActivity extends AppCompatActivity {
    ...
    private void loadData() {
        db.activityDao().getActivitiesByPhase(phaseName).observe(this, activities -> {
            adapter.setActivities(activities);
        });

        db.expenseDao().getTotalByPhase(1, phaseName).observe(this, total -> {
            tvPhaseTotal.setText(String.format(Locale.getDefault(), "₱%.2f", total != null ? total : 0.0));
        });
    }
    ...
    class ActivityAdapter extends RecyclerView.Adapter<ActivityAdapter.ViewHolder> {
        ...
        ActivityAdapter(List<ActivityEntity> activities) {
            this.activities = activities;
        }

        void setActivities(List<ActivityEntity> activities) {
            this.activities = activities;
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_activity_method, parent, false);
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            db.expenseDao().getTotalByActivity(1, activity.getId()).observe(ActivityListActivity.this, total -> {
                holder.tvTotal.setText(String.format(Locale.getDefault(), "Total: ₱%.2f", total != null ? total : 0.0));
            });
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View v) {
                ...
                tvTotal = v.findViewById(R.id.tv_total_cost);
            }
        }
    }
}
