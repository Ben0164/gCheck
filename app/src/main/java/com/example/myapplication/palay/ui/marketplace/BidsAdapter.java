...
public class BidsAdapter extends RecyclerView.Adapter<BidsAdapter.Holder> {
    ...
    public interface OnBidActionListener {
        void onAccept(MarketplaceRepository.SmartBid smartBid);
    }
    ...
    public void setProductionCostPerKg(double cost) {
        this.productionCostPerKg = cost;
    }
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        // True Profit = Net Offer (Bid - Transport) - Production Cost
        ...
        holder.btnAccept.setOnClickListener(v -> {
            if (listener != null) listener.onAccept(sb);
        });
    }
